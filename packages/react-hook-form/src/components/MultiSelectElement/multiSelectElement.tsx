...
type MultiSelectElementComponent = <
  ...
  TName extends FieldPath<TFieldValues> = FieldPath<TFieldValues>
>(
  props: MultiSelectElementProps<TFieldValues, TName> & RefAttributes<HTMLDivElement>
) => JSX.Element
...
const MultiSelectElement = forwardRef(function MultiSelectElement<
  TFieldValues extends FieldValues = FieldValues,
  TName extends FieldPath<TFieldValues> = FieldPath<TFieldValues>
>(props: MultiSelectElementProps<TFieldValues, TName>, ref: Ref<HTMLDivElement>): JSX.Element {
  const {
    options,
    label = '',
    itemKey = 'id',
    ...
    <FormControl
      ...
      <Select
        ...
        {options.map((item) => {
          ...
          const isChecked = Array.isArray(field.value) ? field.value.includes(val) : false
          return (
            <MenuItem
              key={val}
              value={val}
